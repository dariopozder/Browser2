define('ace/ext/searchbox-css', [
        ...
        'use strict';
        var r = e('../lib/dom'), i = e('../lib/lang'), s = e('../lib/event'), o = e('./searchbox-css'), u = e('../keyboard/hash_handler').HashHandler, a = e('../lib/keys'), f = e('../config').nls, l = 999;
        ...
        var c = function () {
                ...
                return e.prototype.setEditor = function (e) {
                    ...
                    var e = this.editor, t = e.$search.$options.re, n = t.unicode, r = 0, s = 0;
                    if (t) {
                        var o = this.searchRange ? e.session.getTextRange(this.searchRange) : e.getValue(), u = e.session.doc.positionToIndex(e.selection.anchor);
                        this.searchRange && (u -= e.session.doc.positionToIndex(this.searchRange.start));
                    ...
                    this.searchCounter.textContent = '$0 of $1'
        ...
        c.prototype.$searchBarKb = h, c.prototype.$closeSearchBarKb = p, t.SearchBox = c, t.Search = function (e, t) {
